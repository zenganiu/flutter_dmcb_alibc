...
__attribute__((annotate("IgnoreChecker:notification_miss_pair")))
@interface IJKFFMoviePlayerController : NSObject <IJKMediaPlayback>

+ (instancetype)defalutPlayerWithUrl:(NSString *)url;

+ (instancetype)defalutPlayerWithUrl:(NSString *)url options:(IJKFFOptions *)options;
...
@property (strong, readonly, nonatomic) NSValue *videoRectValue;

@property (assign, nonatomic) UIInterfaceOrientation renderViewOrientation;

- (NSString *)getLiveStreamServerIP;
- (NSString *)getLocalIP;
- (NSString *)getRouteNodes;
- (NSDictionary *)getIJKPlayerProperties;
- (NSString *)getIJKPlayerStringWithType:(int)type;
...
- (double)switchVideoResolutionSmoothly;
- (void)setPropertyFloat:(float)value forKey:(NSString*)key;
- (void)setPropertyInt64:(float)value forKey:(NSString *)key;
