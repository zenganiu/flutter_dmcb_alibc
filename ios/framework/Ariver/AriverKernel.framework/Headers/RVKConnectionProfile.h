...
@property(nonatomic, weak) RVKRouter        *previousRouter;
@property(nonatomic, strong) RVKRouter      *nextRouter;
@property(nonatomic, weak) RVKRouter        *lastRouter;
@property(nonatomic, strong) NSDate         *startDate;
@property(nonatomic, strong) NSDate         *finishDate;

- (instancetype)initWithUrl:(NSString *)url statusCode:(NSInteger)statusCode redirectUrl:(NSString *)redirectUrl;

- (void)addRouter:(RVKRouter *)nextRouter;
...
@property(nonatomic, strong) RVKRouter  *router;
...
- (void)merge:(RVKConnectionProfile *)profile; // 除了startDate，startTime，status
