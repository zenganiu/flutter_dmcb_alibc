...
typedef NS_ENUM(NSUInteger, RVKEventPhase) {
    RVKEventPhase_Capture,
    RVKEventPhase_Target,
    RVKEventPhase_Bubbling,
};

typedef NS_ENUM(NSInteger, RVKPluginPriority) {
    RVKPluginPriority_High = 2,
    RVKPluginPriority_Default = 0,
    RVKPluginPriority_Low = -2,
};

#define kRVKAriverBundlePath                    @"AriverKernel.bundle"
#define kRVKAriverConfigFileName                @"AriverKernel-Config.plist"
#define kRVKBundleName                          [RVKConfigGet() pluginsBundleName]
...
#define kRVKScope_Proxy                         @"proxy" // global级别
#define kRVKScope_Service                       @"service" // global级别
#define kRVKScope_Session                       @"session" // global级别，对所有session生效
#define kRVKScope_Scene                         @"scene" // global级别，对所有scene生效

// proxy--request的headers中包含以下key会走拦截
#define kRVKProxyRequestHeaderKey               @"kRVKProxyRequestHeaderKey"
#define kRVKProxyRequestHeaderKey1              @"kRVKProxyRequestHeaderKey1"
// ChannelId（id获取优先级：header > ua）
#define kRVKProxyRequestHeaderChannelIdKey      @"kRVKProxyRequestHeaderChannelIdKey" // --> 同一个页面配置相同的ChannelId

#define kRVKProxyRequestFromSDK                 @"Ariver"

#define KRVKWKFakePersistentCookie              @"KRVKWKFAKEPERSISTENTCOOKIE"
#define KRVKWKSharedCookies                     @"KRVKWKSharedCookies"
#define KRVKDocumentHref                        @"document.location.href"
#define KRVKMainUrlFallback                     @"KRVKMainUrlFallback"
#define KRVKUrlFromHttpRequest                  @"KRVKUrlFromHttpRequest"
...
#define kEvent_Session_CloseClicked             @"session.clickedClose"

//**********************Scene       Events************************//
#define kEvent_Scene_InitParams                 @"scene.initParams"
...
#define kRVKSceneInjectRequest          @"kRVKSceneInjectRequest"
#define KRVKXMSGTK                      @"msgKt"
#define KRVKXMSGREQUESTURL              @"msgRequestUrl"

//********************** other ***********************//
//可以通过runtime的方式获得当前request是否是主文档的请求
#define kRVKWEBVIEWISMAINFRAMEREQUEST   @"kRVKWEBVIEWISMAINFRAMEREQUEST"
#define kRVKISRVKPLUGINGS               @"kRVKISRVKPLUGINGS"
#define kRVKSCHEMTASKREDIRECTURL        @"kRVKSCHEMTASKREDIRECTURL"
