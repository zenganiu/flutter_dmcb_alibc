...
//JsApi配置类
@interface RVKJsApiConfig : NSObject
...
@property(nonatomic, readonly, strong) RVKJsApiHandlerBlock handler; // JsApi处理函数
 ...
 *  @return 返回JsApi配置对象
 */
+ (instancetype)jsApiCfgWithHandlerBlock:(RVKJsApiHandlerBlock)handler
                                   jsApi:(NSString *)jsApi;
