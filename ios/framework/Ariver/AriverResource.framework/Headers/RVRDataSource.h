...
#import "RVRAppDataSourceProtocol.h"
...
@property (nonatomic, weak) RVRDataSource *dataSource;      // dataSource
...
@class RVRApp;
@protocol RVRSignVerifyDelegate<NSObject>
@optional
- (BOOL)verify:(NSString *)path;
- (BOOL)verify:(NSString *)path app:(RVRApp *)app;
@end

// App数据源对象: 离线数据的获取
@interface RVRDataSource : NSObject<RVRAppDataSourceProtocol>
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wincompatible-property-type"
@property (nonatomic, readonly, strong) RVRApp *app;
@property (nonatomic, weak) id<RVRSignVerifyDelegate> signVerifyDelegate;
#pragma clang diagnostic pop
 ...
 */
- (RVRAppResponse *)responseWithUrlString:(NSString *)urlString;
 ...
 *  @return 返回tabbar数据
 */
- (NSDictionary *)readNBTabBarConfig;
