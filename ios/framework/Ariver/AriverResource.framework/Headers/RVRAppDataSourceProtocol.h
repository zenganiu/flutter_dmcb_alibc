...
@property (nonatomic, weak) id<RVRAppDataSourceProtocol> dataSource;   // dataSource
@property (nonatomic, strong) NSDictionary *headers;
@end

@protocol RVRAppDataSourceProtocol <NSObject>
@property (nonatomic, readonly, strong) id<RVAppProtocol> app;
 ...
 *  @return 返回数据源对象
 */
- (instancetype)initWithApp:(id<RVAppProtocol>)app;
 ...
 */
- (id<RVRAppResponseProtocol>)responseWithUrlString:(NSString *)urlString;
