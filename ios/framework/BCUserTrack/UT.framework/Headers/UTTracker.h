 ...
 */
- (NSString *)getPageSpmUrl:(id)pPageObject;
 ...
 */
- (NSString *)getPageSpmPre:(id)pPageObject;
 ...
 */
- (NSString *)getUtParamUrl:(id)pPageObject;
 ...
 */
- (NSString *)getUtParamPre:(id)pPageObject;
 ...
 */
- (NSString *)getScmPre:(id)pPageObject;

/**
 * 获取页面属性. 包括:spm-cnt,spm-url,spm-pre,utparam-cnt,utparam-url,utparam-pre
 *
 * 注意:
 * 1.该方法必须在pageAppear和pageDisappear的中间过程调用
 * 2.传入的pageObject必须和pageAppear的pageObject为同一对象
 * 3.该方法不支持H5容器页面
 * 4.异常情况返回值为null,请注意做非空判断
 */

- (NSDictionary *)getPageAllProperties:(id)pPageObject;
